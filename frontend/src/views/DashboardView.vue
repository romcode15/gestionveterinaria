...
<template>
  <DashboardLayout>
    ...
    <!-- Contenedor principal: flex column ocupando todo el espacio disponible -->
    <div class="flex flex-col h-full gap-6 p-6 min-h-0">

      <!-- Saludo — altura fija, no scrollea -->
      <div class="shrink-0">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 shrink-0">
        ...
        >
          <div class="flex items-center gap-4">
            ...
            >
              <svg class="w-6 h-6" :style="{ color: stat.iconColor }"
      ...
      <!-- Área inferior: ocupa el espacio restante, scroll interno solo en citas -->
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-0">

        <!-- Citas de hoy — columna principal con scroll interno -->
        ...
        <!-- Panel derecho — scroll propio si el contenido crece -->
